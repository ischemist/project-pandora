...
# dependencies = [
#   "retrocast @ git+https://github.com/ischemist/project-procrustes",
# ]
# ///
...
DATA_DIR = Path(__file__).resolve().parents[3] / "data" / "retrocast"
...
if __name__ == "__main__":
    ...
    check_route_direction(DATA_DIR / "0-assets" / "routes_possible_test_hard.pkl", DATA_DIR / "0-assets" / "uspto-190.csv")
