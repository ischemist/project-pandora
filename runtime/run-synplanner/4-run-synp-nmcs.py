...
Example usage:
    uv run --directory runtime/run-synplanner 4-run-synp-nmcs.py --benchmark uspto-190
    uv run --directory runtime/run-synplanner 4-run-synp-nmcs.py --benchmark random-n5-2-seed=20251030 --effort high
...
if __name__ == "__main__":
    ...
    save_synplanner_results(
        ...
        script_name="runtime/run-synplanner/4-run-synp-nmcs.py",
        benchmark=benchmark,
