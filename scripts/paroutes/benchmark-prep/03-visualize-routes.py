...
# dependencies = [
#   "retrocast[viz] @ git+https://github.com/ischemist/project-procrustes",
# ]
# ///
...
def main() -> None:
    ...
    for var in variants:
        ...
        n1_routes = {k: v.primary_route for k, v in n1_set.targets.items()}
        n5_routes = {k: v.primary_route for k, v in n5_set.targets.items()}
